...
const STYLE_TEMPLATE_PRESETS = Object.freeze({
  realistic: Object.freeze({
    ...
    videoGenerationStylePrompt:
      '整体视觉风格保持写实影视质感，优先还原原片的真实人物比例、真实服装材质、真实场景结构、真实光线方向和真实镜头运动，不要生成漫画线稿感、夸张二次元比例或明显插画质感。',
  ...
  comic_drama: Object.freeze({
    ...
    videoGenerationStylePrompt:
      '整体视觉风格保持国漫影视化。人物比例、轮廓和妆造要稳定，画面允许更强的分镜感、边缘概括和漫画化色彩组织，但镜头运动、空间关系、动作衔接和表演节奏仍需贴近原片，避免纯写实或纯二次元平面化。',
    promptOptimizationStylePrompt:
